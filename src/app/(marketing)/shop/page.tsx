...
const products = [
  {
    ...
    name: "Premium Metal",
    price: 59,
    desc: "Official engraved MigSmartCard metal NFC. Premium finish.",
    features: ["Engraved logo", "Metal body", "NFC ready"],
  ...
  },
  {
    ...
    price: 49,
    desc: "Pastel metal NFC with your official MigSmartCard engraving.",
    features: ["Engraved logo", "Pastel finish", "NFC ready"],
  ...
  },
  {
    ...
    name: "Custom Brand",
    price: 55,
    desc: "Premium engraved card — custom colorways on request.",
    features: ["Engraved logo", "Custom colors", "Bulk discounts"],
