                ...
                <div className="overflow-hidden rounded-[1.35rem] bg-white text-slate-900 shadow-2xl">
                  ...
                  <div className="-mt-12 flex flex-col items-center px-6 pb-6">
                    ...
                    <div className="mt-4 flex w-full gap-2">
                      ...
                      <div className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border-2 border-brand-600 py-2.5 text-xs font-semibold text-brand-600">
                        Exchange
                      </div>
                    </div>
                    <div className="mt-4 w-full space-y-2">
                      {["+971 50 123 4567", "alex@mignet.io", "mignet.io"].map(
                        (item) => (
                          <div
                            key={item}
                            className="rounded-xl bg-slate-50 px-4 py-2.5 text-xs font-medium text-slate-600"
                          >
                            {item}
                          </div>
                        )
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-8 opacity-50 grayscale">
            {["Mignet", "Acme Corp", "Globex", "Initech", "Umbrella"].map(
              (name) => (
                <span
                  key={name}
                  className="text-lg font-bold tracking-tight text-slate-700 dark:text-slate-300"
                >
                  {name}
                </span>
              )
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-3">
            {steps.map((s) => (
              <div key={s.step} className="relative text-center">
                <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-600 text-white shadow-glow">
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={item.label} className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-brand-50 text-brand-600 dark:bg-brand-950">
