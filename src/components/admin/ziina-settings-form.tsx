  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Connect Ziina for subscription and card-order payments. Paste the API
          token from Ziina; the webhook secret is optional and generated by you.
          Environment variables always take precedence over values saved here.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-4">
          ...
          />
          <Input
            label="Webhook secret (optional — you create this)"
            type="password"
            autoComplete="off"
            value={secret}
            ...
            placeholder={
              config?.secretSet
                ? "Saved — enter a new value to replace"
                : "Optional, e.g. openssl rand -hex 32"
            }
          />
